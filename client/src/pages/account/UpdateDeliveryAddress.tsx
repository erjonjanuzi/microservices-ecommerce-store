...
export default observer(function UpdateDeliveryAddress() {
            ...
            <Formik
                initialValues={
                    sameAsAccountAddress ? {
                        ...
                        country: userStore.user.deliveryAddress.country,
                        city: userStore.user.deliveryAddress.city,
                        postCode: userStore.user.deliveryAddress.postCode,
                        street: userStore.user.deliveryAddress.street,
                        error: null
                    }}
