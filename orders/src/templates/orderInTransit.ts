...
export const orderInTransit = (order: OrderDoc) => {
    return `
    ...
    * {
    ...
    <!--[if !mso]><!--><link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900" rel="stylesheet" type="text/css"><!--<![endif]-->
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td style="padding-right: 0px;padding-left: 0px;" align="center">
          ...
          <img align="center" border="0" src="https://res.cloudinary.com/dcfzd0pgt/image/upload/v1657451390/logos/logo-fit-transparent_r7gw4v.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 185px;" width="185"/>
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 130%; text-align: left; word-wrap: break-word;">
        <p style="line-height: 130%; text-align: center; font-size: 14px;"><span style="color: #000000; font-family: Poppins, sans-serif; font-size: 14px; line-height: 18.2px;"><span style="font-size: 30px; line-height: 39px;"><strong>Your order is on its way</strong></span></span></p>
      </div>
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="color: #000000; font-size: 14px; line-height: 19.6px;"><span style="font-size: 16px; line-height: 22.4px; font-family: arial, helvetica, sans-serif;">This email is to confirm your recent order is now in transit and</span></span></p>
    <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="color: #000000; font-size: 14px; line-height: 19.6px;"><span style="font-size: 16px; line-height: 22.4px; font-family: arial, helvetica, sans-serif;">will soon arrive at your doorstep. </span></span></p>
    <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="color: #000000; font-size: 14px; line-height: 19.6px;"><span style="font-size: 16px; line-height: 22.4px; font-family: arial, helvetica, sans-serif;"><strong>Order ID: #${order.orderNo}</strong></span></span></p>
      </div>
    ...
    <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;">${product.product.title}</span></p>
    </div>
    ...
    <div style="line-height: 140%; text-align: right; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;">${product.product.sale > 0 ? ((
                product.product.price -
                product.product.price * (product.product.sale / 100)
            ) * product.quantity).toFixed(2) : (product.product.price * product.quantity).toFixed(2)} EUR</span></p>
    </div>
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%; text-align: right;"><span style="font-size: 16px; line-height: 22.4px;">FREE</span></p>
      </div>
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%; text-align: right;"><span style="font-size: 16px; line-height: 22.4px;"><strong>${order.totalPrice.toFixed(2)} EUR</strong></span></p>
      </div>
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      ${order.contact.billingAddress.city}, ${order.contact.billingAddress.postCode}<br>
      ${order.contact.billingAddress.street}
      </h3>
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      ${order.contact.deliveryAddress.city}, ${order.contact.deliveryAddress.postCode}<br>
      ${order.contact.deliveryAddress.street}
      </h3>
